...
* **[Mathematical Journey](https://www.google.com/search?q=MATHEMATICAL_JOURNEY.md)** - Discovery process
...
* [Secret of the Ancients](https://www.google.com/search?q=research/LE_SECRET_MATHEMATIQUE_DES_ANCIENS.md) - Perfect numbers & Tzolk'in
* [Universal Language Analysis](https://www.google.com/search?q=research/LANGAGE_UNIVERSEL_ET_CRYPTO_TZOLKIN.md) - Complete analysis
* [Perfect Numbers Study](https://www.google.com/search?q=research/perfect_numbers_analysis.md)
...
See [manifest.json](https://www.google.com/search?q=manifest.json) for complete project relationships.
...
| 📖 **API Docs** | [docs/api_reference.md](https://www.google.com/search?q=docs/api_reference.md) |
| 🧪 **Examples** | [examples/](https://www.google.com/search?q=examples/) |
